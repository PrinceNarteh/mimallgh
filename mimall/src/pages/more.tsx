          ...
          <div className="col-span-8 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-5">
              {Array(4)
                .fill(0)
                .map(() => (
                  <div className="relative h-96 rounded-md bg-gray-500 bg-opacity-20 p-5">
                    <div className="flex items-center justify-between">
                      <span className="block h-12 w-12 rounded-full bg-[#ff0000]"></span>
                      <span className="block text-xl text-gray-700 line-through">
                        $120.00
                      </span>
                    </div>
                    <span className="absolute bottom-5 text-xl font-bold text-orange-500">
                      $105.00
                    </span>
                  </div>
                ))}
